...
class ResNet(nn.Module):
    ...
    #     out = self.layer3(out)
    #     out = self.layer4(out)
    #     out = F.avg_pool2d(out, 4)   #其他用这个
    #     #out = F.adaptive_avg_pool2d(out, (1, 1))  #tinyimagenet用这个
    ...
    #     else:
    #         return out
    def forward(self, x, return_features=False, y=None):
        out = F.relu(self.bn1(self.conv1(x)))
        out = self.layer1(out)
        out = self.layer2(out)
        out = self.layer3(out)
